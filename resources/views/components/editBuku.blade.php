...
<div x-data="{ editBuku: false }">
    <button @click="editBuku =!editBuku" class="block bg-blue-700 p-2 mr-3 rounded-lg text-white"
    ...
    <div x-show="editBuku"
        ...
        <div
            ...
            <div x-cloak x-show="editBuku" x-transition:enter="transition ease-out duration-300 transform"
