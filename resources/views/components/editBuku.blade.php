...
<div x-data="{ editBuku: false }">
    <button @click="editBuku =!editBuku" class="block bg-blue-700 p-2 mr-3 rounded-lg text-white" style="height:36px; weight:49px; !important" type="button">
    ...
    <div x-show="editBuku" class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full justify-center items-center" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full justify-center items-center">
            <div x-cloak @click="editBuku = false" x-show="editBuku" 
            ...
            <div class="flex items-center justify-between space-x-4">
                ...
                <button @click="editBuku = false" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-mainclr rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
            ...
            <form method="post" action="admin/buku/">
                ...
                <div class="p-5">
                    <div>
                        <label for="idbuku" class="block w-fit text-sm font-medium text-gray-900 dark:text-gray-300">Id Buku</label>
                        <input type="text" id="idbuku" name="idbuku" class="@error('idbuku') invalid:border-red-500 @enderror mb-2 block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-mainclr focus:border-mainclr dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-mainclr dark:focus:border-mainclr " autofocus required>
                        @error('idbuku')
                    ...
                    <div>
                        <label for="kategori" class="block w-fit text-sm font-medium text-gray-900 dark:text-gray-300">Id Buku</label>
                        <input type="text" id="idbuku" name="idbuku" class="@error('idbuku') invalid:border-red-500 @enderror mb-2 block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-mainclr focus:border-mainclr dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-mainclr dark:focus:border-mainclr " autofocus required>
                        @error('idbuku')
                            <div class="text-red-500 text-xs font-medium">
                                {{ $message }}
