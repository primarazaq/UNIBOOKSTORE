...
<div x-data="{ delBuku: false }">
    <button @click="delBuku =!delBuku"
    ...
    <div x-show="delBuku"
        ...
        <div
            ...
            <div x-cloak @click="delBuku = false" x-show="delBuku"
            ...
            <div x-cloak x-show="delBuku" x-transition:enter="transition ease-out duration-300 transform"
                ...
                <div class="p-6 text-center">
                    ...
                    <div class="flex justify-center">
                        <button @click="delBuku = false" type="button"
                        ...
                        <form action="/admin/aturbuku/{{ $data->id_buku }}" method="post">
                            @method('delete')
                            @csrf
                            <input type="hidden" name="id_buku" value="{{ $data->id_buku }}" hidden>
                            <button type="submit"
