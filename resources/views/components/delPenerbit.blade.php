...
<div x-data="{ delPenerbit: false }">
    <button @click="delPenerbit =!delPenerbit"
        class="block text-white bg-red-600 p-2 rounded-lg font-medium text-sm py-2 text-center" type="button">
    ...
    <div x-show="delPenerbit"
        ...
        <div
            ...
            <div x-cloak x-show="delPenerbit" x-transition:enter="transition ease-out duration-300 transform"
                ...
                <div class="p-6 text-center">
                    <svg aria-hidden="true" class="mx-auto mb-4 w-52 text-gray-400 dark:text-gray-200 stroke-red-600"
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah anda yakin ingin
                        menghapus penerbit ini?</h3>
                    <div class="flex justify-center">
                        <button @click="delPenerbit = false" type="button"
                        ...
                        <form action="/admin/aturbuku/{{ $data->id_penerbit }}" method="post">
                            ...
                            @csrf
                            <button type="submit"
                                class="inline-flex border-0 text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-3xl text-sm items-center px-5 py-2.5 text-center mr-2">
                                Ya, saya yakin
                            </button>
                        </form>
                    </div>
