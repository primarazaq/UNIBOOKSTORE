...
<div x-data="{ editPenerbit: false }">
    <button @click="editPenerbit =!editPenerbit" class="block bg-blue-700 p-2 mr-3 rounded-lg text-white"
    ...
    <div x-show="editPenerbit"
        ...
        <div
            ...
            <div x-cloak x-show="editPenerbit" x-transition:enter="transition ease-out duration-300 transform"
                ...
                <div class="flex items-center justify-between space-x-4">
                    ...
                    <button @click="editPenerbit = false"
                    ...
                    <div class="p-5">
                        <div>
                            ...
                            <input type="text" id="id_penerbit" name="id_penerbit"
                                ...
                                autofocus required value="{{ old('id_penerbit', $data->id_penerbit) }}">
                            @error('id_penerbit')
                        ...
                        <div>
                            ...
                            <input type="text" id="alamat" name="alamat"
                                ...
                                autofocus required value="{{ old('alamat', $data->alamat) }}">
                            @error('alamat')
                                <div class="text-red-500 text-xs font-medium">
                                    {{ $message }}
                                </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="kota" name="kota"
                                ...
                                autofocus required value="{{ old('kota', $data->kota) }}">
                            @error('kota')
                                <div class="text-red-500 text-xs font-medium">
                                    {{ $message }}
                                </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="telepon" name="telepon"
                                ...
                                required value="{{ old('telepon', $data->telepon) }}">
                            @error('telepon')
                                <div class="text-red-500 text-xs font-medium">
                                    {{ $message }}
                                </div>
